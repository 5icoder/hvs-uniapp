		...
		>
			<view class="uni-header">
				...
				<view class="uni-group">
					<input class="uni-search" type="text" v-model="searchVal" placeholder="请输入姓名" />
...
export default {
	...
	methods: {
		...
		// 搜索
		search() {
			this.query = `form_id=='CODE_FORM_002'&&record.data.name=='${this.searchVal}'`
		},
		// 重置
		reload() {
			this.query = `form_id=='CODE_FORM_002'`
		}
	}
}
</script>
